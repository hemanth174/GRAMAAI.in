// database.js - SQLite Database for Patient Portal
...
export async function initDatabase() {
    ...
    try {
        db = await open({
            filename: './patients-portal.db',
            driver: sqlite3.Database
        });

        console.log('📊 Patient Portal Database connected successfully');
        ...
        console.log('✅ Patient Portal Database tables created successfully');
        return db;
    } catch (error) {
